...
@TeleOp
public class MaliceAndCondescensionNEW extends Movable implements LimelightTags { // robot #22335
    ...
    private static final int HIGH_MOTOR_POWER = 4100;
    private static final int LOW_MOTOR_POWER = 3300;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        PIDFCoefficients pidfCoefficientsFar = new PIDFCoefficients(1.5, 0, 0.1, 17.8);
        PIDFCoefficients pidfCoefficientsClose = new PIDFCoefficients(1.3,0,0.1,16.1);
        outtakeMotor.setPIDFCoefficients(DcMotorEx.RunMode.RUN_USING_ENCODER, pidfCoefficientsFar);
        targetVelocity = HIGH_MOTOR_POWER;
...
//            }
            ...
            if (gamepad1.dpadRightWasPressed()) {
                targetVelocity = HIGH_MOTOR_POWER;
                outtakeMotor.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER,pidfCoefficientsFar);
            } else if (gamepad1.dpadLeftWasPressed()) {
                targetVelocity = LOW_MOTOR_POWER;
                outtakeMotor.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER,pidfCoefficientsClose);
            }
            ...
            if (outtakeToggle) {
                //outtakeMotor.setVelocity(targetVelocity / 60 * 28);
                outtakeMotor.setPower(1);
            } else {
                outtakeMotor.setVelocity(0);
            }
            telemetry.addData("Target Velocity", targetVelocity);
            telemetry.addData("Velocity", outtakeMotor.getVelocity() * 60/28);
