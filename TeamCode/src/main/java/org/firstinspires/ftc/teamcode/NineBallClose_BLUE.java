...
@Autonomous
public class NineBallClose_BLUE extends Movable {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        scorePreload = follower.pathBuilder()
                .addPath(new BezierLine(DOOM_BLUE_CLOSE_START, BLUE_CLOSE_SCORE))
                .setLinearHeadingInterpolation(
                        DOOM_BLUE_CLOSE_START.getHeading(),
                        BLUE_CLOSE_SCORE.getHeading())
                .build();
