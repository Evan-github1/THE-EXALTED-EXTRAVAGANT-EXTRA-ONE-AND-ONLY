...
@Autonomous
public class CloseTwelveBallAuto_BLUE extends Movable {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        PathChain goToPickup1 = follower.pathBuilder()
                .addPath(new BezierLine(BLUE_CLOSE_SCORE,BLUE_BALL1_START))
                .setLinearHeadingInterpolation(BLUE_CLOSE_SCORE.getHeading() , BLUE_BALL1_START.getHeading())
                .build();
        
        PathChain grabPickup1 = follower.pathBuilder()
                .addPath(new BezierLine(BLUE_BALL1_START,BLUE_BALL1_END))
                .setLinearHeadingInterpolation(BLUE_BALL2_START.getHeading(), BLUE_BALL1_END.getHeading())
                .build();
        
        PathChain scorePickup1 = follower.pathBuilder()
                .addPath(new BezierLine(BLUE_BALL1_END,BLUE_CLOSE_SCORE))
                .setLinearHeadingInterpolation(BLUE_BALL1_END.getHeading(), BLUE_CLOSE_SCORE.getHeading())
                .build();
