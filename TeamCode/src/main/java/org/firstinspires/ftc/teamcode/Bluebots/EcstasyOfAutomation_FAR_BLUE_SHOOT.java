...
@Autonomous
public class EcstasyOfAutomation_FAR_BLUE_SHOOT extends EcstasyOfAutomation {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        sleep(500);*/
        swivelTurretServo.setPosition(.52);
        //PrincessEyesv4(20, true);
        ...
        move(Direction.STRAFE_RIGHT, 2800, .3);
        ...
        move(Direction.STRAFE_LEFT, 3000, .3);
        ...
        move(Direction.STRAFE_RIGHT, 500, 1);
