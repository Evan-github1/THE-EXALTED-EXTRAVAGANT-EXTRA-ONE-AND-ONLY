...
public class DoomAndDisgust_PEDROBLUEFAR extends Movable {
    ...
    private final Pose readyClearClassifier = new Pose(144-100,67,Math.PI-0);
    private final Pose clearClassifier = new Pose(144-130,67,Math.PI-0);
    private final Pose score3Pivot = new Pose(144-90,67,Math.PI-0);
    private final Pose closeShoot = new Pose(144-85,85,-Math.PI/4);
