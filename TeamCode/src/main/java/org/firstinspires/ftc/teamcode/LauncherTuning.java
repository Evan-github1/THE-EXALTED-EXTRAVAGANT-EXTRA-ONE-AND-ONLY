...
@TeleOp
public class LauncherTuning extends Movable implements LimelightTags {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Close motor power",motorPowerClose);
            telemetry.addData("Far motor power",motorPowerFar);
            telemetry.update();
        }
    }
