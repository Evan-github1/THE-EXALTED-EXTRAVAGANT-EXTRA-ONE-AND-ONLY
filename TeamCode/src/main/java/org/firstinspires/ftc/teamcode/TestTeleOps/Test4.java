...
@TeleOp
public class Test4 extends LinearOpMode implements LimelightTags {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Target Area", getTA(limelight));
            //telemetry.addData("Distance", getDistanceFromTag(getTA(limelight)));
