...
public class DoomAndDisgust_PEDROREDCLOSE extends Movable {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        scorePreload = follower.pathBuilder()
                .addPath(new BezierLine(DOOM_RED_CLOSE_START,DOOM_RED_CLOSE_SCORE))
                .setLinearHeadingInterpolation(DOOM_RED_CLOSE_START.getHeading(),DOOM_RED_CLOSE_SCORE.getHeading())
                .build();
        goToLeavePose = follower.pathBuilder()
                .addPath(new BezierLine(DOOM_RED_CLOSE_SCORE,DOOM_RED_CLOSE_LEAVE))
                .setLinearHeadingInterpolation(DOOM_RED_CLOSE_SCORE.getHeading(),DOOM_RED_CLOSE_LEAVE.getHeading())
                .build();
